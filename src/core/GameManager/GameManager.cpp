...
void GameManager::setUI() {
  ...
  this->_renderer.pushUITexture(
      new Entity("../res/bg/menu.png", this->_renderer.getRenderer()));
  this->_renderer.pushUITexture(new Counter(
      "../res/ui/counter.jpg", this->_renderer.getRenderer(),
      this->_renderer.getTTF(), {30, 10}, {100, 50}, &player1Score));
  this->_renderer.pushUITexture(new Counter(
      "../res/ui/counter.jpg", this->_renderer.getRenderer(),
      this->_renderer.getTTF(), {400, 10}, {100, 50}, &player2Score));
}
